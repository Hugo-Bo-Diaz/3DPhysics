...
ModulePhysics3D::ModulePhysics3D(Application* app, bool start_enabled) : Module(app, start_enabled)
{
	...
	col_dispatcher = new btCollisionDispatcher(config);
...
bool ModulePhysics3D::Start()
{
	...
	world = new btDiscreteDynamicsWorld(col_dispatcher, broadphase, constraint_solver, config);
